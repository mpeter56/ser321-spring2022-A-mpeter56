...
public class EchoClient {
  ...
  /**
   * calls read on the server and prints out the full list
   */
  ...
  /**
   * calls write on the server
   * @param name[name for entry]
   * @param city[city in entry]
   * @param region[state or country in entry]
   */
  ...
  /**
   * calls echo on the server
   * @param message[message to be echod]
   */
  ...
  /**
   * calls the listShape method on the server
   */
  ...
  /**
   * calls the area method on the server
  ...
  /**
   * calls the parameter method on the server
   * @param name[name of the shape]
   * @param width[width of the shape]
   * @param height[height of the shape]
   */
  ...
  /**
   * calls the addShape method on server
   * @param name[name of the shape]
   * @param areaEquation[ area equation for the shape]
   * @param parameterEquation[parameter equation for the shape]
   * @param directions[directions on how to use the calculation for this shape]
   */
  ...
  /**
   * timer menu
   * @param client[connection to server]
   */
  public static void timerMenu(EchoClient client) {
	  try {
   ...
   * @param client[connection to server]
   */
  public static void homeTownMenu(EchoClient client) {
	  try {
	      BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
   ...
   * @param client[connection to server]
   */
  public static void echoMenu(EchoClient client) {
	  BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
	  try {
   ...
   * @param client[connection to server]
   */
  public static void jokeMenu(EchoClient client) {
   ...
   * @param client[connection to server]
   */
  public static void calcShapeMenu(EchoClient client) {
	  Scanner reader = new Scanner( System.in );
	  BufferedReader readr = new BufferedReader(new InputStreamReader(System.in));
	  try {
	      ...
	      if(choice.equals("1")) {
	    	  ...
	    	  if(reader.hasNextDouble()) {
		    	  ...
		    	  if(reader.hasNextDouble()) {
		    		  ...
		    		  client.askForCalcShapeArea(choice, width, height);
		    	  }else {
	    	  ...
	    	  if(reader.hasNextDouble()) {
		    	  ...
		    	  if(reader.hasNextDouble()) {
		    		  height = reader.nextDouble();
		    		  client.askForCalcShapeParameter(choice, width, height);
		    	  }else {
		    		  System.out.println("Height must be a number");
		    	  }
	    	  }else {
	    	  ...
	    	  client.askForCalcShapeAddShape(name, areaEquation, parameterEquation, directions);
	      }else if(choice.equals("5")) {
	    	  mainMenu(client);
	      }else {
	    	  System.out.println("Invalid selection");
   ...
   * @param client[connection to server]
   */
  public static void mainMenu(EchoClient client) {
	  try {
